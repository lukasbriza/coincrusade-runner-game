...
export const predictWithNnModel = async (chunk: ChunkLog) => {
    ...
    const model = await tf.loadLayersModel("file://" + path.resolve("dist", "ml-models", "trained_models", "nn_86", "model.json"))
